# SQUIDCTRL DUMP FOR MYSQL DATABASE
 ...
 CREATE TABLE `groups` ( `count` int(11), `name` char(25), `nick` char(25), `value` char(10)) ENGINE=MyISAM;
 ...
 CREATE TABLE `ipreplace` ( `ip` char(15), `user` char(25), `domain` char(25)) ENGINE=MyISAM;
 DROP TABLE IF EXISTS `log`;
 CREATE TABLE `log` ( `user` char(25), `date` date, `time` time, `value` char(60), `code` char(2)) ENGINE=MyISAM;
 DROP TABLE IF EXISTS `passwd`;
 CREATE TABLE `passwd` ( `user` char(25), `pass` char(60), `access` int(11)) ENGINE=MyISAM;
 ...
 CREATE TABLE `reconfig` ( `number` int(2),`service` varchar (15),`action` varchar(10), `value` varchar(110)) ENGINE=MyISAM;
 INSERT INTO reconfig VALUES('1','sams','','');
 DROP TABLE IF EXISTS `redirect`;
 CREATE TABLE `redirect` ( `name` varchar(25), `filename` varchar(25), `type` varchar(25), `show` int(10) unsigned, `redirect_to` varchar(100)) ENGINE=MyISAM;
 ...
 CREATE TABLE `sconfig` ( `sname` char(25), `set` char(25)) ENGINE=MyISAM;
 DROP TABLE IF EXISTS `sguard`;
 CREATE TABLE `sguard` ( `sname` varchar(25), `name` varchar(100), `domain` char(1), `url` char(1), `expr` char(1)) ENGINE=MyISAM;
 DROP TABLE IF EXISTS `shablons`;
 CREATE TABLE `shablons` ( `name` varchar(25), `nick` varchar(25), `shablonpool` bigint, `userpool` bigint, `redirect_to` varchar(100),`auth` varchar(4),`traffic` int(25) ,`days` varchar(14),`shour` tinyint(2) UNSIGNED ZEROFILL,`smin` tinyint(2) UNSIGNED ZEROFILL,`ehour` tinyint(2) UNSIGNED ZEROFILL,`emin` tinyint(2) UNSIGNED ZEROFILL, `period` char(3) NOT NULL default 'M', `clrdate` date NOT NULL default '0000-00-00',`alldenied` tinyint(1) NOT NULL default '0' ) ENGINE=MyISAM;
 ...
 CREATE TABLE `proxyes` ( `id` tinyint(3) default '0', `description` varchar(50) default 'Proxy server', `endvalue` int(20) default '0') ENGINE=MyISAM;
